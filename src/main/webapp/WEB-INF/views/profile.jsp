        ...
        <div class="col-sm-3">
            ...
            <c:choose>
                <c:when test="${user.username == currentUser}">
                    ...
                    <a href="/${user.username}/editAccountDetails" class="btn btn-primary"><spring:message code="label.accountDetails.edit"/></a>
                    <a href="/${user.username}/changePasswd" class="btn btn-primary"><spring:message code="label.changePassword"/></a>
                    <a href="/addImg" class="btn btn-primary"><spring:message code="label.setAvatar"/></a>
                    <!-- Koniec opcji -->
                </c:when>
                <c:otherwise>
