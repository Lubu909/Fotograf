...
CREATE TABLE IF NOT EXISTS `fotograf`.`orders` (
  ...
  `status` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_order_user_roles1_idx` (`klient_id` ASC),
  INDEX `fk_order_user_roles2_idx` (`fotograf_id` ASC),
  CONSTRAINT `fk_order_user_roles1`
    FOREIGN KEY (`klient_id`)
    REFERENCES `fotograf`.`user_roles` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_order_user_roles2`
